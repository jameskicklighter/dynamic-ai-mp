...
- AI tuning helper dirs skipped: `False`
...
### `common/ai_strategy_plans/GER_alternate_strategy_plan.txt`
Missing: `2`
  - `object:German_alternate_kaiser` (base line 2)
  - `object:German_alternate_kaiser_GD` (base line 356)
...
Review candidates: `1`
  - `object:ENG_destroyers` (base line 3)

### `common/ai_equipment/SOV_tank.txt`
Review candidates: `1`
  - `object:SOV_heavy_tank_destroyer` (base line 1604)

### `common/ai_equipment/USA_tank.txt`
Review candidates: `1`
  - `object:USA_medium_tank_destroyer` (base line 928)
...
### `common/ai_strategy_plans/ENG_historical_strategy_plan.txt`
Review candidates: `1`
  - `object:ENG_historical_plan` (base line 1)

### `common/ai_strategy_plans/GER_alternate_strategy_plan.txt`
Review candidates: `1`
  - `object:German_alternate_democratic_ww` (base line 213)

### `common/ai_templates/templates_ENG.txt`
Review candidates: `1`
  - `object:infantry_ENG` (base line 282)
...
Changed upstream objects absent from mod: `7`
  - `object:armor_generic` (base line 1)
  - `object:suppression_generic` (base line 320)
  - `object:infantry_generic` (base line 375)
  - `object:mountaineers_generic` (base line 472)
  - `object:marines_generic` (base line 527)
  - `object:paratrooper_generic` (base line 630)
  - `object:rangers_generic` (base line 682)

### `common/ai_templates/templates_CHI.txt`
Changed upstream objects absent from mod: `1`
  - `object:infantry_CHI` (base line 2)

### `common/ai_templates/templates_ENG.txt`
Changed upstream objects absent from mod: `4`
  - `object:armor_ENG` (base line 1)
  - `object:mountaineers_ENG` (base line 364)
  - `object:marines_ENG` (base line 414)
  - `object:paratrooper_ENG` (base line 463)

### `common/ai_templates/templates_GER.txt`
Changed upstream objects absent from mod: `9`
  - `object:armored_GER` (base line 1)
  - `object:panzergrenadier_GER` (base line 228)
  - `object:garrison_GER` (base line 448)
  - `object:infantry_GER` (base line 499)
  - `object:mountaineers_GER` (base line 664)
  - `object:marines_GER` (base line 710)
  - `object:paratroopers_GER` (base line 757)
  - `object:anti_armor_GER` (base line 855)
  - `object:motorized_GER` (base line 921)

### `common/ai_templates/templates_HUN.txt`
Changed upstream objects absent from mod: `3`
  - `object:armor_HUN` (base line 1)
  - `object:infantry_HUN` (base line 304)
  - `object:mobile_HUN` (base line 412)

### `common/ai_templates/templates_ITA.txt`
Changed upstream objects absent from mod: `5`
  - `object:armored_ITA` (base line 1)
  - `object:infantry_ITA` (base line 351)
  - `object:mountaineers_ITA` (base line 426)
  - `object:marines_ITA` (base line 475)
  - `object:paratroopers_ITA` (base line 526)

### `common/ai_templates/templates_JAP.txt`
Changed upstream objects absent from mod: `6`
  - `object:armor_JAP` (base line 1)
  - `object:infantry_JAP` (base line 214)
  - `object:mountaineers_JAP` (base line 327)
  - `object:marines_JAP` (base line 376)
  - `object:paratrooper_JAP` (base line 462)
  - `object:garrison_JAP` (base line 509)

### `common/ai_templates/templates_SOV.txt`
Changed upstream objects absent from mod: `7`
  - `object:armored_SOV` (base line 1)
  - `object:breakthrough_armor_SOV` (base line 235)
  - `object:infantry_SOV` (base line 515)
  - `object:mountaineers_SOV` (base line 624)
  - `object:marines_SOV` (base line 674)
  - `object:paratroopers_SOV` (base line 723)
  - `object:anti_armor_SOV` (base line 772)

### `common/ai_templates/templates_USA.txt`
Changed upstream objects absent from mod: `6`
  - `object:armor_USA` (base line 1)
  - `object:infantry_USA` (base line 336)
  - `object:mobile_USA` (base line 409)
  - `object:mountaineers_USA` (base line 588)
  - `object:marines_USA` (base line 635)
  - `object:paratroopers_USA` (base line 762)
